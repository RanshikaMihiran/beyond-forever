...
const AestheticSection = () => {
  return (
    <section className="py-20 md:py-32 px-5 md:px-8 relative bg-white overflow-hidden">
        ...
        <div className="max-w-[1400px] mx-auto">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-12 md:mb-20 gap-6 md:gap-0">
                ...
                <p className="text-[#3a3a3a]/60 text-sm md:text-base max-w-[280px] md:max-w-sm leading-relaxed md:text-justify">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-0 border-t border-l border-[#3a3a3a]/10">
                ...
                {AESTHETIC.map((item, idx) => (
                    <div 
                        key={idx} 
                        className="group relative p-8 sm:p-10 md:p-12 lg:p-16 border-r border-b border-[#3a3a3a]/10 hover:bg-[#0a0a0a] active:bg-[#0a0a0a] transition-colors duration-700 ease-[cubic-bezier(0.25,1,0.5,1)] cursor-pointer md:cursor-default"
                    >
                        
                        {/* Number Indicator */}
                        <div className="absolute top-6 right-6 md:top-8 md:right-8 text-[10px] md:text-xs font-mono text-[#3a3a3a]/30 group-hover:text-white/30 transition-colors duration-500">
                            /{item.id}
                        </div>

                        {/* Icon */}
                        <div className="text-[#B3907A] mb-8 md:mb-12 transform group-hover:scale-110 transition-transform duration-500 origin-left">
                            {item.icon}
                        </div>

                        {/* Content */}
                        <div className="relative z-10">
                            <h3 className="font-serif text-2xl md:text-3xl lg:text-4xl mb-3 md:mb-4 text-[#3a3a3a] group-hover:text-white transition-colors duration-500">
                                {item.title}
                            </h3>
                            <p className="text-[#3a3a3a]/60 text-xs md:text-sm leading-relaxed md:leading-loose group-hover:text-white/70 transition-colors duration-500 pr-2">
                                {item.desc}
                            </p>
                        </div>
